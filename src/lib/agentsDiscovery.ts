 ...
 * `projectPath` is the workbench project root (not PI_AGENT_HOME).
 */
...
/** True when a file name is a Pi agent definition (markdown). */
 ...
 * Later scopes do not dedupe — Pi keeps same-name defs visible per scope;
